...
<div class="menu">
  <div class="menu-left">
    <div class="menu-A1">
      ...
      <div class="menu-a11">
        <img src="images/d2.jpg"  width="80" height="95"/>
    ...
    <div class="menu-A2">
      <div class="menu-a2">
        <h3>
          【进口】歌帝梵GODIVA牛奶白黑巧克力礼盒14枚圣诞生日节日送礼
        </h3>
        <h1>￥258</h1>
      </div>
      <div class="menu-a3">
      ...
      <div class="menu-a4">
          <div id="box">
            ...
            <div class="addgoodArea">
              ...
              <div class="addgood">&nbsp;&nbsp;&nbsp;¥<input type="text" id="money" value="258"/></div>
            </div>
          </div>
        <br />
      </div>
      <div class="menu-a5">
            <button foodId=1 type="button" class="addToCart">加入购物车 </button> </div>
      <div class="menu-a6">
    ...
    <div class="menu-C">
      <img src="images/SaleDetail3.png" alt="" width="1100px" height="600px">
      </div>
